...
model = Model()
data = {'element': {'model': {},
                    'beam state': {'Q/A': {'abbreviation': 'ref_IonZ'},
                                   'energy': {'abbreviation': 'ref_IonEk'},
                                   'magnetic rigidity': {'abbreviation': 'ref_Brho'},
                                   'x-position': {'abbreviation': 'xcen'},
                                   'y-position': {'abbreviation': 'ycen'},
                                   'z-position': {'abbreviation': 'zcen'},
                                   'x-momentum': {'abbreviation': 'xpcen'},
                                   'y-momentum': {'abbreviation': 'ypcen'},
                                   'z-momentum': {'abbreviation': 'zpcen'},
                                   'x beam size [mm]': {'abbreviation': 'xrms'},
                                   'y beam size [mm]': {'abbreviation': 'yrms'},
                                   'z beam size [mm]': {'abbreviation': 'zrms'},
                                   'x twiss beta [m/rad]': {'abbreviation': 'xtwsb'},
                                   'y twiss beta [m/rad]': {'abbreviation': 'ytwsb'},
                                   'z twiss beta [m/rad]': {'abbreviation': 'ztwsb'},
                                   'x alpha': {'abbreviation': 'xtwsa'},
                                   'y alpha': {'abbreviation': 'ytwsa'},
                                   'z alpha': {'abbreviation': 'ztwsa'},
                                   'x geom. emittance [mm-mrad]': {'abbreviation': 'xeps'},
                                   'y geom. emittance [mm-mrad]': {'abbreviation': 'yeps'},
                                   'z geom. emittance [mm-mrad]': {'abbreviation': 'zeps'},
                                   'x norm. emittance [mm-mrad]': {'abbreviation': 'xepsn'},
                                   'y norm. emittance [mm-mrad]': {'abbreviation': 'yepsn'},
                                   'z norm. emittance [mm-mrad]': {'abbreviation': 'zepsn'}}},
